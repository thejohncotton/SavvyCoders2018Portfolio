...
function buildLinks(linkArray) {
  ...
  linkArray.forEach(function (link) {
    if (route !== "Home") {
      route = (0, _lodash.lowerCase)(link);
    }

    links += "\n                <li>\n                    <a href='/".concat(route, "' data-navigo>\n                        ").concat(link, "\n                    </a>\n                </li>\n            ");
  });
  return links;
}
...
},{}],"projects/cyoa/cyoa.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = cyoa;
...
function cyoa() {
  ...
  } else alert("Now you have a tummy ache."); //handle "peel" and "munch"
...
var _cyoa = _interopRequireDefault(require("../../projects/cyoa/cyoa"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _default() {
  return "\n    <div class=\"container content-area\">\n    <ol>\n        <li><button>Class Showcase</button></li>\n        <li><button id=\"cyoaStart\" onClick=\"".concat((0, _cyoa.default)(), "\">Choose Your Own Adventure</button></li>\n        <li><button>Web Store Hack-A-Thon</button></li>\n    </ol>\n</div>\n\n");
}
},{"../../projects/cyoa/cyoa":"projects/cyoa/cyoa.js"}],"components/pages/Blog.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  posts: [{
    ...
    title: "Daily Minimum Reps",
    body: "<p>There is a lot of research into the human brain and how we humans learn through a pattern of stress and recovery.\nWhile we learn programming it is important to keep this in mind. That brain pain you are experiencing <strong>is good for you!</strong>\nTry to focus on the following every day:\n</p>\n<ul>\n<li>Write new code.</li>\n<li>Update old code.</li>\n<li>Try new things!</li>\n<li>Break things.</li>\n<li>Fix them.</li>\n<li>Use the command line over your typical file system.</li>\n<li>PUSH your code.</li>\n</ul>\n<hr>"
  }],
...
_axios.default.get("https://jsonplaceholder.typicode.com/posts").then(function (response) {
  ...
  response.data.forEach(function (post) {
    return state.Blog.posts.push(post);
  });
...
//         } 
//         checkName()
},{"~/components/Navigation":"components/Navigation.js","~/components/Header":"components/Header.js","~/components/Content":"components/Content.js","~/components/Footer":"components/Footer.js","../store":"store/index.js","lodash":"node_modules/lodash/lodash.js","navigo":"node_modules/navigo/lib/navigo.min.js","axios":"node_modules/axios/index.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
